            ...
            <div class="menu-wrap">
        		...
        		<a href="<?= url(['manager/cover']) ?>" style="display: block;">
	                <div class="menu-item coverings boxflex" data-index="2">
	                    <i class="icon1 icon-coverings"></i>
...
<div class="agent-container">
  <div class="agent-header">
    ...
    <p class="name"><?= $extend->realname ?></p>
    <p class="name"><?= $extend->mobile ?></p>
    <a href="<?= url(['manager/income']) ?>">
    <p class="has-arrow my-input">
        
      <span>我的收入</span>
      <span>￥<?= $extend->rebate_account ?></span>
    </p>
    </a>
  </div>
    <a href="<?= url(['manager/customer']) ?>">
  <p class="sell-item has-arrow">
      <span>直属客户</span>
      <span><?= $userNum ?>人</span>
  </p>
    </a>
    <a href="<?= url(['manager/cover']) ?>">
  <p class="sell-item has-arrow">
      <span>客户平仓</span>
      <span><?= $orderNum ?>笔</span>
  </p>
    </a>
    <a href="<?= url(['manager/card']) ?>">
  <p class="sell-item has-arrow none-arrow">
      <span>我的名片</span>
  </p>
    </a>
</div>