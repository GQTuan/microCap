...
class UserExtend extends \common\models\UserExtend
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            // ['mobile', 'match', 'pattern' => '^1[\d]{10}$', 'message' => '手机号格式错误'],
            [['coding', 'mobile'], 'required', 'on' => ['register']],
            // [['coding'], 'codingValidate'],
            // 短信验证码
    ...
    // public function codingValidate()
    // {
    //     $retail = Retail::find()->where(['code' => $this->coding])->one();
    //     if (empty($retail)) { //529182
    //         $this->addError('coding', '机构编码或代理商编码不正确！');
    //     }
    // }
    /*
     * 获得经纪人二维码图片
    ...
    */ 
    public static function getManagerCodeImg()
    {
        ...
        // if (($urlCode = session('WxUrlCode_' . u()->id)) == null) {
            ...
            // $id = u()->id - 100000;
            $data = ['action_name' => 'QR_LIMIT_SCENE', 'action_info' => ['scene' => ['scene_id' => $user->manager_id]]];
