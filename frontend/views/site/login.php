...
<div class="login-mask">
    <div class="login-container">
        ...
        <a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=<?= wechatInfo()->appid ?>&redirect_uri=http%3a%2f%2f<?= $_SERVER['HTTP_HOST'] ?>/site/register&response_type=code&scope=snsapi_userinfo&state=index#wechat_redirect">用户注册</a></p>
