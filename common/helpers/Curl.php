...
class Curl
{
    ...
    public static function gzip($url, $options = [])
    {
        static::init($options);

        curl_setopt(self::$curl, CURLOPT_URL, $url);
        curl_setopt(self::$curl, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt(self::$curl, CURLOPT_TIMEOUT, 3);
        curl_setopt(self::$curl, CURLOPT_HTTPHEADER, array('Accept-Encoding:gzip'));
    ...
    public static function json($url, $options = [])
    {
        static::init($options);
        ...
        curl_setopt(self::$curl, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt(self::$curl, CURLOPT_TIMEOUT, 3);
        curl_setopt(self::$curl, CURLOPT_HTTPHEADER, array('Accept-Encoding:json'));
        curl_setopt(self::$curl, CURLOPT_ENCODING, "json");
